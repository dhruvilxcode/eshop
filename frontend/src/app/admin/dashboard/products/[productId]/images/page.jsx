...
import { updateProductImages, useProduct } from "@/controllers/products.controller";
...
export default function ProductImagesPage({ params }) {
  ...
  const btnDeleteImage = async (imageId, imageURL) => {
    //TODO:
  }
            ...
            >
              ...
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-4">
                  ...
                  <button className="flex gap-1 text-sm px-2 py-1 border hover:bg-red-100 border-red-400 text-red-400 rounded-md">
